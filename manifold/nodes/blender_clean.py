    ...
    def define_schema(cls):
        return IO.Schema(
            ...
            inputs=[
                ...
                IO.Float.Input("voxel_scale", default=2.5, min=1.0, max=8.0, step=0.1, tooltip="voxel size as a multiple of the median edge length; below about 1.8 the double shell splits, larger smooths"),
