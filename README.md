...
4. Open `workflows/manifold.json`. `workflows/retopo-only.json` runs without weights from any glb, fbx, obj or stl in `~/ComfyUI-Shared/input/3d/`.

## Nodes

Manifold From Mesh, Manifold From File, Quad Remesh, Blender Decimate, Blender Finish, Save Asset. Category `manifold`.
